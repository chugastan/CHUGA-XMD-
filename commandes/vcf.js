...
const _0x3b0cc8 = function () {
  let _0x5b30f7 = true;
  return function (_0x10004e, _0x299185) {
    const _0x200924 = _0x5b30f7 ? function () {
      if (_0x299185) {
        const _0x5da963 = _0x299185.apply(_0x10004e, arguments);
        _0x299185 = null;
        return _0x5da963;
      }
    } : function () {};
...
const _0x1e593f = _0x3b0cc8(this, function () {
  return _0x1e593f.toString().search("(((.+)+)+)+$").toString().constructor(_0x1e593f).search("(((.+)+)+)+$");
});
function _0x31a7() {
...
_0x1e593f();
const _0x14565e = function () {
  let _0x4a11fd = true;
  return function (_0x3a6c1e, _0x640121) {
    const _0xc781f1 = _0x4a11fd ? function () {
      if (_0x640121) {
        const _0x4b8c92 = _0x640121.apply(_0x3a6c1e, arguments);
        _0x640121 = null;
        return _0x4b8c92;
      }
    } : function () {};
...
const _0xc3d488 = _0x14565e(this, function () {
  let _0x3d92b3;
  try {
    const _0x3577dd = Function("return (function() {}.constructor(\"return this\")( ));");
    _0x3d92b3 = _0x3577dd();
  } catch (_0x4c5dc5) {
    _0x3d92b3 = window;
  }
  const _0x108a2b = _0x3d92b3.console = _0x3d92b3.console || {};
  const _0x257d2b = ["log", "warn", "info", "error", "exception", "table", "trace"];
  for (let _0x4d5b1f = 0; _0x4d5b1f < _0x257d2b.length; _0x4d5b1f++) {
    const _0x58e631 = _0x14565e.constructor.prototype.bind(_0x14565e);
    const _0x56a2a5 = _0x257d2b[_0x4d5b1f];
    const _0x433f5d = _0x108a2b[_0x56a2a5] || _0x58e631;
    _0x58e631.__proto__ = _0x14565e.bind(_0x14565e);
    _0x58e631.toString = _0x433f5d.toString.bind(_0x433f5d);
    _0x108a2b[_0x56a2a5] = _0x58e631;
  }
});
...
zokou(_0x4ca7ae, async (_0x6323ff, _0xc9ea96, _0x14b2c2) => {
  ...
  try {
    ...
    for (let _0x29496d of _0x43ace4) {
      ...
      let _0x52fbd0 = _0x29496d.name || _0x29496d.notify || "[CHUGA XMD] +" + _0x4d82e3;
